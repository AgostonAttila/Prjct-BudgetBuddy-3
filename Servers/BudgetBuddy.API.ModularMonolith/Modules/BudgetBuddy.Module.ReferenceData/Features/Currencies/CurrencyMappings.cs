using BudgetBuddy.Module.ReferenceData.Features.Currencies.CreateCurrency;
using BudgetBuddy.Module.ReferenceData.Features.Currencies.UpdateCurrency;
using Mapster;
using static BudgetBuddy.Module.ReferenceData.Features.Currencies.CreateCurrency.CreateCurrencyEndpoint;

namespace BudgetBuddy.Module.ReferenceData.Features.Currencies;
