...
namespace BudgetBuddy.Module.Auth.Infrastructure;

/// <summary>
/// Service for logging and monitoring security events
/// </summary>
public class SecurityEventService(AuthDbContext context, ILogger<SecurityEventService> logger) : ISecurityEventService
{
