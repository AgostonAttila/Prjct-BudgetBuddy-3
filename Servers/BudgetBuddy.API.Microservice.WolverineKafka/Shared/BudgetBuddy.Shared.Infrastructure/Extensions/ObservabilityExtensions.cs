        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithTracing(tracing =>
            {
                tracing
                    ...
                    .AddSource("Wolverine")              // Wolverine message pipeline traces
            ...
            .WithMetrics(metrics =>
            {
                metrics
                    ...
                    .AddMeter("Wolverine")               // Wolverine message throughput, retries, DLQ
                    .AddMeter("BudgetBuddy.Handlers")    // MediatR handler duration + invocations
