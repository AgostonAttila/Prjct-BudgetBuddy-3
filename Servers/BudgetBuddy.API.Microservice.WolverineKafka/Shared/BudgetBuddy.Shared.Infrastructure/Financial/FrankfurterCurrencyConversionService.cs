...
{
    internal const string ClientName = "FrankfurterCurrencyConversionService";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        throw new InvalidOperationException(
            ...
            $"Verify both currencies are supported by the Frankfurter API.");
    }
        ...
        string baseCurrency, CancellationToken cancellationToken)
    {
        ...
        var response = await CreateClient().GetFromJsonAsync<FrankfurterResponse>(
        ...
        {
            throw new InvalidOperationException(
                $"Frankfurter API returned empty or null rates for base currency {baseCurrency}. " +
                "The service may be unavailable or the currency is unsupported.");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await CreateClient().GetFromJsonAsync<FrankfurterRangeResponse>(
