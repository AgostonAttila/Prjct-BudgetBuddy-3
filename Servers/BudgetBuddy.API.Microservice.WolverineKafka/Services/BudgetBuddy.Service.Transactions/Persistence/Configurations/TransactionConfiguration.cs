...
public class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
{
    public void Configure(EntityTypeBuilder<Transaction> builder)
    {
        ...
        builder.Property(t => t.SagaStep)
            .HasDefaultValue(TransactionSagaStep.Started);

        // Supports SagaTimeoutJob: quickly find Started transactions older than N seconds.
        builder.HasIndex(t => new { t.SagaStep, t.CreatedAt })
            .HasFilter($"saga_step = {(int)TransactionSagaStep.Started}")
