namespace BudgetBuddy.Service.Transactions.Features.Transfers.Services;
        ...
        return await strategy.ExecuteAsync(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new InvalidOperationException(
                    $"Transfer failed: {amount} {currencyCode} from {fromAccountId} to {toAccountId}. Transaction rolled back.",
                    ex);
            }
        });
    }
