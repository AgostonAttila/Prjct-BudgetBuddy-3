...
using BudgetBuddy.Service.Investments.Messaging;
...
builder.Services.AddBackgroundJobs(builder.Configuration, q =>
{
    ...
    // InvestmentsOutboxProcessorJob removed — Wolverine polling agent handles outbox delivery
...
builder.AddWolverine(typeof(Program).Assembly, opts => opts.AddInvestmentsMessaging(builder.Configuration));
