...
public class AccountSnapshotHandler
{
        ...
        CancellationToken ct)
    {
        ...
        logger.LogInformation("Account {AccountId} snapshot created in Analytics", evt.AccountId);
    }
        ...
        CancellationToken ct)
    {
        ...
        logger.LogInformation("Account {AccountId} snapshot updated in Analytics", evt.AccountId);
    }
        ...
        CancellationToken ct)
    {
        ...
        logger.LogInformation("Account {AccountId} snapshot deleted from Analytics", evt.AccountId);
    }
}
