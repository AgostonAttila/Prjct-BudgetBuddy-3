using BudgetBuddy.Service.ReferenceData.Messaging;
...
builder.AddWolverine(typeof(Program).Assembly, opts => opts.AddReferenceDataMessaging(builder.Configuration));
