using BudgetBuddy.Service.ReferenceData.Features.Currencies.CreateCurrency;
using BudgetBuddy.Service.ReferenceData.Features.Currencies.UpdateCurrency;
using Mapster;
using static BudgetBuddy.Service.ReferenceData.Features.Currencies.CreateCurrency.CreateCurrencyEndpoint;

namespace BudgetBuddy.Service.ReferenceData.Features.Currencies;
