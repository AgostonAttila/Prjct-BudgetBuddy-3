...
{
    private HttpClient CreateClient() => httpClientFactory.CreateClient(FinancialHttpClientExtensions.CoinGeckoClientName);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await CreateClient().GetFromJsonAsync<Dictionary<string, Dictionary<string, decimal>>>(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await CreateClient().GetFromJsonAsync<CoinGeckoChartResponse>(url, cancellationToken);
