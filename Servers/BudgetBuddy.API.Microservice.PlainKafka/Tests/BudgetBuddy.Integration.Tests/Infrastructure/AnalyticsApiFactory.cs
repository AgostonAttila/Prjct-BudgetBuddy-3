...
using BudgetBuddy.Service.Analytics.Messaging.Consumers;
    ...
    : WebApplicationFactory<BudgetBuddy.Service.Analytics.Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            // Remove all Kafka consumers
            InvestmentsApiFactory.RemoveHostedService<TransactionEventsConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<BudgetEventsConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<InvestmentEventsConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<CategoryChangedConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<AccountChangelogConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<MarketPriceUpdatedConsumer>(services);
            InvestmentsApiFactory.RemoveHostedService<KafkaTopicValidatorService>(services);
        });
    }
