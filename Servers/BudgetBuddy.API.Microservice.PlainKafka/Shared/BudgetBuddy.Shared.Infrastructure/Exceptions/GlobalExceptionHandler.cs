...
using Npgsql;
using ValidationException = BudgetBuddy.Shared.Kernel.Exceptions.ValidationException;
...
public class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> logger, IHostEnvironment environment) : IExceptionHandler
{
        ...
        IHostEnvironment environment)
    {
        return exception switch
        {
            ...
            // A-16: Bulkhead rejected — surface as 503 so clients can back off and retry
