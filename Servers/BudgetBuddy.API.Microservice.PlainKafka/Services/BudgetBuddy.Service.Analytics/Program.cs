...
// Kafka consumers
builder.Services.AddHostedService<TransactionEventsConsumer>();
builder.Services.AddHostedService<BudgetEventsConsumer>();
builder.Services.AddHostedService<InvestmentEventsConsumer>();
builder.Services.AddHostedService<CategoryChangedConsumer>();
builder.Services.AddHostedService<AccountChangelogConsumer>();
builder.Services.AddHostedService<MarketPriceUpdatedConsumer>();
