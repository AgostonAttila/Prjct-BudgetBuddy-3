...
namespace BudgetBuddy.Service.Investments.Messaging.Consumers;
...
public sealed class AccountChangelogConsumer(
    ...
    : KafkaMultiTopicConsumerBase(
        ...
        ConsumerGroups.InvestmentsAccounts,
        scopeFactory,
        logger)
{
        ...
        IServiceProvider services, CancellationToken ct)
    {
        ...
        if (payload is null)
        {
            ...
            Logger.LogInformation("Account {AccountId} removed from Investments snapshot (tombstone)", accountId);
            return;
        }
