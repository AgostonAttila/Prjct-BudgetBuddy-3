using BudgetBuddy.Service.ReferenceData.Features.CategoryTypes.CreateCategoryType;
using BudgetBuddy.Service.ReferenceData.Features.CategoryTypes.UpdateCategoryType;
using Mapster;

namespace BudgetBuddy.Service.ReferenceData.Features.CategoryTypes;
