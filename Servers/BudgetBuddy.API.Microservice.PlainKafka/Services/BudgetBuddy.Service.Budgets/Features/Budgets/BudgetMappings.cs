...
using BudgetBuddy.Service.Budgets.Features.UpdateBudget;
using Mapster;
using static BudgetBuddy.Service.Budgets.Features.CreateBudget.CreateBudgetEndpoint;
using static BudgetBuddy.Service.Budgets.Features.UpdateBudget.UpdateBudgetEndpoint;

namespace BudgetBuddy.Service.Budgets.Features;
