...
/// Free tier: ~30 req/min without a key. Register a free demo key at coingecko.com/api
/// to increase the limit to ~50 req/min.
/// </summary>
    ...
    ILogger<CoinGeckoPriceProvider> logger) : IPriceProvider, IHistoricalPriceProvider
{
    ...
    // CoinGecko identifies coins by ID, not ticker symbol.
    // Unknown symbols fall back to symbol.ToLowerInvariant() which works for many smaller coins.
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Build symbol → CoinGecko ID mapping for this batch
    ...
    // CoinGecko returns daily granularity automatically when range > 90 days.
    // Timestamps are in milliseconds. Prices are in USD.
